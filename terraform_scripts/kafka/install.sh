...
echo "Running the Docker and Docker-compose install script." 1>>$LOGFILE 2>&1
git clone https://github.com/DerekKing001/kafka-in-docker.git 1>>$LOGFILE 2>&1
cd kafka-in-docker 1>>$LOGFILE 2>&1
